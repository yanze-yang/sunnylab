...
import { ProductsContext, IProduct } from "../contexts/products.context";
...
const ProductList = ({ product }: { product: IProduct }) => {
  ...
  return (
    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
      ...
      >
        <img className="w-10 h-10 rounded-full" src={imageUrl} alt={imageUrl} />
        <div className="pl-3">
          <div className="text-base font-semibold">{name}</div>
          <div className="font-normal text-gray-500">{category.name}</div>
        </div>
      </th>
